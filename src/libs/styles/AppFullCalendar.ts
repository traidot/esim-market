  ...
  '& .fc': {
    ...
    '& .fc-event': {
      ...
      '&.event-bg-info': {
        ...
        '& .fc-list-event-title, & .fc-list-event-time': {
          color: 'var(--mui-palette-info-main) !important'
        },
        '&:hover td': {
    ...
    // Today cell (Month & Week views only, not Day view) - primary tonal background
    '& .fc-day-today:not(.fc-popover):not(.fc-timeGridDay-view .fc-day-today)': {
      backgroundColor: 'var(--mui-palette-primary-lightOpacity)',
    ...
    // Day view: không highlight ngày hiện tại, và business hours có background trắng
    '& .fc-timeGridDay-view': {
      '& .fc-day-today': {
        backgroundColor: 'transparent',
      ...
      // Business hours trong day view có background trắng
    ...
    '& .fc-timegrid': {
      ...
      // Non-business hours (ngoài 7h-19h hoặc ngoài ngày làm việc) sẽ được làm mờ với màu xám
      '& .fc-non-business': {
        backgroundColor: 'var(--mui-palette-action-hover)',
        opacity: 0.6
      },
      // Style cho slot label và lane ngoài giờ làm việc
    ...
    '& .fc-list': {
      ...
      '.fc-list-event': {
        ...
        // Event color classes for list view - higher specificity
        '&.event-bg-primary': {
          '& .fc-list-event-title, & .fc-list-event-time': {
            color: 'var(--mui-palette-primary-main) !important'
          },
        ...
        '&.event-bg-success': {
          ...
          '& .fc-list-event-dot': {
            borderColor: 'var(--mui-palette-success-main) !important',
        ...
        '&.event-bg-warning': {
          ...
          '& .fc-list-event-dot': {
            borderColor: 'var(--mui-palette-warning-main) !important',
        ...
        '&.event-bg-info': {
          ...
          '& .fc-list-event-dot': {
            borderColor: 'var(--mui-palette-info-main) !important',
      ...
      '& .fc-list-event-title': {
        ...theme.typography.body1,
        // Don't set default color here - let event-bg-* classes handle it
