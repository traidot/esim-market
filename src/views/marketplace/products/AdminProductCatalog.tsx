...
const AdminProductCatalog = () => {
  ...
  const handleToggleStatus = (id: string, currentStatus: string) => {
    ...
    toast.success(`Đã ${currentStatus === 'Đang hoạt động' ? 'tắt' : 'bật'} gói cước thành công!`)
  }
  ...
  const baseProducts = [
    { code: 'JP-30D-10GB', name: 'Nhật Bản Siêu Tốc', country: 'Nhật Bản', data: '10GB', validity: '30 Ngày', upstream: 'Airalo', upstreamPrice: 10.50, price: 12.50, status: 'Đang hoạt động' },
    { code: 'EU-15D-5GB', name: 'Roaming Châu Âu', country: 'Châu Âu', data: '5GB', validity: '15 Ngày', upstream: 'Truphone', upstreamPrice: 7.00, price: 9.00, status: 'Đang hoạt động' },
    { code: 'US-30D-20GB', name: 'Mỹ Không giới hạn', country: 'Hoa Kỳ', data: '20GB', validity: '30 Ngày', upstream: 'Nomad', upstreamPrice: 18.00, price: 22.00, status: 'Tạm dừng' },
    { code: 'VN-30D-20GB', name: 'Viettel 4G Local', country: 'Việt Nam', data: '20GB', validity: '30 Ngày', upstream: 'MobiMatter', upstreamPrice: 4.00, price: 5.50, status: 'Đang hoạt động' },
    { code: 'TH-07D-Unlimited', name: 'Thái Lan Travel', country: 'Thái Lan', data: 'Unlimited', validity: '7 Ngày', upstream: 'Airalo', upstreamPrice: 4.50, price: 6.20, status: 'Đang hoạt động' },
    { code: 'TH-15D-15GB', name: 'Thái Lan Business', country: 'Thái Lan', data: '15GB', validity: '15 Ngày', upstream: 'Truphone', upstreamPrice: 8.50, price: 12.00, status: 'Đang hoạt động' },
    { code: 'TH-30D-50GB', name: 'Thái Lan Dài Hạn', country: 'Thái Lan', data: '50GB', validity: '30 Ngày', upstream: 'Airalo', upstreamPrice: 18.00, price: 25.00, status: 'Đang hoạt động' },
    { code: 'KR-14D-10GB', name: 'Hàn Quốc Tốc Độ Cao', country: 'Hàn Quốc', data: '10GB', validity: '14 Ngày', upstream: 'Nomad', upstreamPrice: 12.00, price: 15.00, status: 'Đang hoạt động' },
    { code: 'TW-05D-3GB', name: 'Đài Loan Ngắn Ngày', country: 'Đài Loan', data: '3GB', validity: '5 Ngày', upstream: 'MobiMatter', upstreamPrice: 3.00, price: 4.50, status: 'Đang hoạt động' },
    { code: 'CN-30D-50GB', name: 'Trung Quốc Vượt Tường Lửa', country: 'Trung Quốc', data: '50GB', validity: '30 Ngày', upstream: 'Truphone', upstreamPrice: 20.00, price: 28.00, status: 'Đang hoạt động' }
  ]
            ...
            <table className='w-full text-left border-collapse'>
              <thead>
                <tr className='bg-slate-50 border-be'>
                  ...
                  <th className='p-4 text-xs font-black text-slate-500 uppercase'>Upstream</th>
                  <th className='p-4 text-xs font-black text-slate-500 uppercase'>Giá Nhập</th>
                  <th className='p-4 text-xs font-black text-slate-500 uppercase'>Giá Bán</th>
                  <th className='p-4 text-xs font-black text-slate-500 uppercase'>Lợi nhuận</th>
              ...
              <tbody>
                {filteredProducts.map((p) => {
                  const margin = p.price - p.upstreamPrice
                  const marginPercent = ((margin / p.upstreamPrice) * 100).toFixed(1)
                  ...
                  <tr key={p.id} className='border-be last:border-0 hover:bg-slate-50/50'>
                    ...
                    <td className='p-4'>
                      <Chip label={p.upstream} size='small' variant='tonal' color='secondary' className='font-bold' />
                    </td>
                    <td className='p-4'><Typography variant='body2' className='font-mono text-error font-bold'>${p.upstreamPrice.toFixed(2)}</Typography></td>
                    <td className='p-4'><Typography variant='body2' className='font-mono font-black text-primary'>${p.price.toFixed(2)}</Typography></td>
                    <td className='p-4'>
                      <Typography variant='body2' className='font-mono text-success font-bold'>
