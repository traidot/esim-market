    ...
    <div className='flex items-center justify-center min-bs-[100dvh] relative p-6 overflow-x-hidden'>
      <div className='flex items-center flex-col text-center'>
        <div className='flex flex-col gap-2 is-[90vw] sm:is-[unset] mbe-6'>
          <Typography variant='h4'>{t('misc.underMaintenance.title')}</Typography>
          <Typography>{t('misc.underMaintenance.description')}</Typography>
        </div>
        <Button href={getLocalizedUrl('/', locale as Locale)} component={Link} variant='contained'>
          {t('misc.underMaintenance.backToHome')}
        </Button>
        <img
