  ...
  const renderMenuItems = (data: VerticalMenuDataType[]) => {
    ...
    return data.map((item: VerticalMenuDataType, index) => {
      ...
      if (menuSectionItem.isSection) {
        ...
        const { children, isSection, icon, href, excludeLang, prefix, suffix, ...rest } = menuSectionItem
      ...
      if (subMenuItem.children) {
        const { children, icon, prefix, suffix, exactMatch, activeUrl, ...rest } = subMenuItem
        ...
        return (
          <VerticalSubMenu
            ...
            {...rest}
            {...buildExactMatchProps(exactMatch, activeUrl, rest.href)}
            {...(Icon && { icon: Icon })}
          >
            {children && renderMenuItems(children)}
          </VerticalSubMenu>
      ...
      const { label, excludeLang, icon, prefix, suffix, exactMatch, activeUrl, ...rest } = menuItem
      ...
      return (
        <VerticalMenuItem
          ...
          {...rest}
          href={href}
          {...buildExactMatchProps(exactMatch, activeUrl, href)}
          {...(Icon && { icon: Icon })}
        >
          {label}
        </VerticalMenuItem>
