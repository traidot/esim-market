      ...
      <div className='bg-[#211B2C]'>
        ...
        >
          <Typography className='text-white' variant='body2'>
            ...
            <span>{` by `}</span>
            <Link href='https://deepsync.vn/' target='_blank' className='font-medium text-white'>
              DEEPSYNC TECHNOLOGY
            </Link>
          </Typography>
          <div className='flex gap-1.5 items-center'>
            <IconButton component={Link} size='small' href='https://www.facebook.com/dxs-solutions/' target='_blank'>
