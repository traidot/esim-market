...
*Dành cho quản trị viên điều hành toàn bộ hệ sinh thái.*
...
- `/system/settings` - **Cấu hình Hệ thống**: Cài đặt tỷ giá, phí vận hành, tham số hệ thống.
...
*Dành cho đối tác mua và phân phối eSIM.*
